...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage walkingSpriteSheet  = ImageIO.read(Main.class.getResourceAsStream("/img/myhero.png"));
        BufferedImage runningSpriteSheet = ImageIO.read(Main.class.getResourceAsStream("/img/myherorun.png"));
        ...
        Playground playground = new Playground("/map.txt");
